  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col pb-7 w-full bg-[#292826] max-lg:max-w-full">
        ...
        <div className="container mx-auto flex flex-col justify-center self-end py-18 lg:py-20 pr-20 pl-24 w-full text-center text-white max-w-[1418px] max-lg:px-5 max-lg:max-w-full overflow-hidden">
          <div className="flex flex-col items-center w-full max-lg:max-w-full">
            <div className="flex flex-col max-w-full w-[548px]">
              <div className="gap-2.5 self-stretch p-2.5 w-full text-3xl font-semibold min-h-[59px] max-lg:max-w-full">
                Our Work
              </div>
              <div className="self-center mt-5 mb-10 text-base font-medium max-lg:max-w-full">
            ...
            <div className="w-full">
              <Swiper
                ...
                loop
                centeredSlides
                className="w-full !overflow-visible shadow-after-before"
              >
                {[1, 2, 3, 4, 5, 6, 6].map((_, slideIndex) => (
                  <SwiperSlide key={slideIndex}>
                    <div className="custom-grid">
                      {new Array(8).fill("").map((_, index) => (
                        <img
                          key={index}
                          className={`h-full w-full object-cover div${(index % 5) + 1}`}
